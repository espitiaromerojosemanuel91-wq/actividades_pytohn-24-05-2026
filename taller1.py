# Funcion para analizar calificaciones
def analizar_calificaciones(calificaciones):
    # Validar que la lista no este vacia para evitar errores de division por cero
...
# Lista vacia para almacenar las entradas del usuario
notas = []
...
while True:
    ...
    try:
        # Convertir la entrada a numero decimal
        nota = float(entrada)
        notas.append(nota)
    except ValueError:
        # Manejo de error si el usuario no ingresa un numero valido
        print("Error! Por favor ingresa un numero valido o la palabra fin.")

# Validar si el usuario ingreso al menos una nota antes de calcular
if len(notas) > 0:
    # Llamar funcion
